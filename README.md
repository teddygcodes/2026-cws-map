...
- **🎯 Daily pick'em** — pick the winner of **every game** as its matchup unlocks (regionals G1–G7, super-regionals best-of-3), building a running **W–L record**. Picks lock at each game's first pitch.
